      ...
      <div className="bg-white p-8 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className=" mb-4 mt-8">
            ...
            <p>
              Pre-Owned Patek Philippe Grand Complications Perpetual Calendar
              (5140J001) self - winding automatic watch, features a 37.2mm 18k
              yellow gold case surrounding a silver dial on a black alligator
              strap with an 18k yellow gold Calatrava Cross deployant buckle.
              Functions include hours, minutes, seconds, chronograph, date, day,
              month, moon phase and perpetual calendar
            </p>
          </div>
          <div className=" mb-4 mt-8">
            <h1 className="text-2xl font-semibold ">Features</h1>
            <h1 className="mt-2 border-b border-gray-300 font-light">
              WATCH DETAILS
            </h1>
            <div className="mt-4">
              <div className="flex flex-col">
                ...
                <div className="flex items-center mb-2">
                  <h1 className="w-36 text-black-600 font-bold">
                    Screen Size:
                  </h1>
                  <p className="text-gray-600">Red</p>
                </div>
