      ...
      <Link to='/client/product-detail'>
        ...
        <div className='p-6 flex flex-col justify-center gap-1 '>
          <h5 className='mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50 text-center truncate'>
            ...
            veniam explicabo quidem quaerat laudantium cum. Eos, atque mollitia recusandae officiis
            ab cum? Explicabo at voluptas quos perspiciatis laborum!
          </h5>
          <Rating />
          <div className='flex gap-4 justify-center'>
            <p className='mb-4 text-lg font-semibold text-main-red '>4.999.000đ</p>
